...
unique(fossils$cc) # how many countries have fossil crocodiles and list them
...
```{r}
sort(unique(fossils$stratscale))
length(sort(unique(fossils$stratscale)))
```

What proportion of our occurrences are marine crocodiles? (hint: taxon_environment column)

```{r}
sort(unique(fossils$taxon_environment))
length(sort(unique(fossils$taxon_environment)))
